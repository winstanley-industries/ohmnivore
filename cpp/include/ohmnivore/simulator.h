...
struct TranResult {
  ...
  std::vector<std::pair<std::string, std::vector<double>>> node_voltages;
  std::vector<std::pair<std::string, std::vector<double>>> branch_currents;
};
...
[[nodiscard]] Result<TranResult> SimulateTransient(std::string_view netlist);
[[nodiscard]] Result<std::string>
SimulateTransientToCsv(std::string_view netlist);
